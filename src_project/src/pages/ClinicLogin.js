      ...
      <div className="FormCenter">
        <form className="FormFields" onSubmit={this.handleSubmit}>
          <div className="FormField">
            ...
            <input type="text" id="id" className="FormField__Input" placeholder="Enter your Clinic ID" name="id" value={this.state.id} onChange={this.handleChange} />
          </div>
